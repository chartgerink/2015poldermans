...
where *n* is the total amount of data points in that condition. In the case that no events occurred in the condition and *p* = 0, *p* is calculated as for example

$p=\frac{c+.5}{a+c+.5}$

where a and c are indicated in Table 1. This adjustment prevents computational errors and introduces minimal bias [@agresti2002]. 

These meta-analyses result in four estimates:

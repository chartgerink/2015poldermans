...
legend(x = 0, y = .5, bty = 'n', lty = c(1, 2), legend = c("Distribution estimate", "Point estimate"))
...
legend(x = 0, y = .55, bty = 'n', lty = c(1, 2), legend = c("Distribution estimate", "Point estimate"))
...
|            | Estimate              | Lowerbound  | Upperbound | N    |
|-------------|-----------------------|-------------|------------|------|
| DECREASE-I  | Distribution estimate | 0           | 79;85;90   | 113  |
|            | Point estimate        | 0           | 108;110    | 113  |
| DECREASE-IV | Distribution estimate | 0           | 1054       | 1067 |
|            | Point estimate        | 0           | 718        | 1067 |
